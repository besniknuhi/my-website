...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_ymo3ezb", "template_izwk8hq", form.current, {
      publicKey: "PKoUSM0_q0_p6-bYS",
    });
    e.target.reset();
  };
  return (
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">nuhibesnik@gmail.com</span>

              <a href="mailto:nuhibesnik@gmail.com" className="contact__button">
                Write me
